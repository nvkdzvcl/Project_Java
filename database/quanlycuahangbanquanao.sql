...
-- INSERT INTO PHIEUNHAP (TRANGTHAI,`TONGTIEN`, MANV) VALUES
--  (1,3125000,1),
--  (2,1725000,1),
--  (3,2600000,2);
...
-- INSERT INTO HOADON (TRANGTHAI,`DIACHI`, TONGTIEN, MANV, MAKHACHHANG) VALUES
-- (1,'12 Lê Lợi, Huế', 90000, 1, 1),
-- (2,'45 Nguyễn Trãi, Hà Nội', 25000, 1, 4),
-- (3,'78 Trần Hưng Đạo, TP.HCM', 260000, 2, 5);
-- INSERT INTO CTHOADON (MAHOADON,`MASP`,`DONGIA`,`SOLUONG`) VALUES
-- (1,1,40000,1),(1,2,25000,2),
-- (2,2,25000,1),
-- (3,3,30000,2),(3,4,50000,4);
